...
export TERRAFORM_PROVIDER_VERSION ?= 0.5.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-azuredevops
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-azuredevops_0.5.0
...
xpkg.build.provider-azuredevops: do.build.images
